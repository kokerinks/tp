        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), new MembershipPoints(),
                    getAllergenSet("LF"), new Points("0"), getOrderArrayList("Cupcake|200|3|2007-12-03T10:15:30")),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new MembershipPoints(),
                    getAllergenSet("EG"), new Points("0"), getOrderArrayList("Kaya Toast|300|1|2024-01-01T07:00:00")),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new MembershipPoints(),
                    getAllergenSet("V"), new Points("0"), getOrderArrayList("Cheese Tart|150|6|2023-06-30T23:23:23")),
